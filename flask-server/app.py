...
app.config['UPLOAD_FOLDER_ADMIN'] = '/Users/dhkim/PycharmProjects/testPython/pythonProject/storage/admin'  # 업로드 파일을 저장할 서버 내 경로
app.config['UPLOAD_FOLDER_RA'] = '/Users/dhkim/PycharmProjects/testPython/pythonProject/storage/RA'  # 업로드 파일을 저장할 서버 내 경로
app.config['UPLOAD_FOLDER_TMP'] = '/Users/dhkim/PycharmProjects/testPython/pythonProject/storage/tmp'  # 업로드 파일을 저장할 서버 내 경로
