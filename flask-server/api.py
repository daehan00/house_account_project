...
def create_ra():
    try:
        ...
        # 필수 필드 체크
        required_fields = ['user_id', 'user_name', 'user_num', 'email_address', 'year', 'semester', 'house_name']
        ...
        new_ra = RAList(
            ...
            division_num=data.get('division_num'),  # division_num은 옵셔널 필드로 처리
            email_address=data['email_address'],
            year=data['year'],
            semester=data['semester'],
            house_name=data['house_name'],
            authority=data.get('authority')  # authority도 옵셔널 필드로 처리
        )
